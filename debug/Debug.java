...
public class Debug {
	 ...
	 * @throws IOException 파일 입출력 오류가 발생할 수 있습니다.
	 */
	public static void setDebug(boolean debug, String inputFile) throws IOException {
		instance.DEBUG = debug;
		instance.USE_INPUT_FILE = true;
	...
	public static void setInputFile(boolean set) throws IOException {
		...
		if (instance.DEBUG && instance.USE_INPUT_FILE)
	...
	/**
	 * int 2차원 배열을 출력합니다. 지정된 값과 같은 경우 0으로 출력합니다.
	 *
	 * @param arr    출력할 int 2차원 배열
	 * @param ignore 무시할 값. 이 값과 같은 경우 0으로 출력됩니다.
	 */
	...
	/**
	 * int 2차원 배열의 일부분을 출력합니다. 지정된 값과 같은 경우 0으로 출력합니다.
	 *
	 * @param arr     출력할 int 2차원 배열
	...
	/**
	 * int 2차원 배열을 출력합니다. 특정 위치에 있는 값을 지정된 문자로 대체하여 출력하고, 지정된 값과 같은 경우 0으로 출력합니다.
	 *
	 * @param arr     출력할 int 2차원 배열
	 * @param row     문자를 대체할 행 인덱스
	 * @param col     문자를 대체할 열 인덱스
	...
	/**
	 * int 1차원 배열의 일부분을 출력합니다. ignore 값과 같은 경우 0으로 출력합니다.
	 *
	 * @param arr    출력할 int 1차원 배열
	 * @param start  출력을 시작할 위치
	 * @param end    출력을 종료할 위치 (exclusive)
	...
	/**
	 * int 1차원 배열의 일부분을 출력합니다. 특정 위치의 값을 chkChar로 대체하여 출력합니다. ignore 값과 같은 경우 0으로
	 * 출력합니다.
	 *
	 * @param arr     출력할 int 1차원 배열
	 * @param start   출력을 시작할 위치
	...
	/**
	 * int 1차원 배열의 전체 출력합니다. 특정 위치의 값을 chkChar로 대체하여 출력합니다. ignore 값과 같은 경우 0으로
	 * 출력합니다.
	 *
	 * @param arr     출력할 int 1차원 배열
	 * @param chkIdx  출력을 대체할 위치
